...
export function mountHeaderPresentation() {
  ...
  const sentences = [
    'Hello :)',
    "I'm Mathieu, a fullstack developper !",
    'You can find me as Skrollu on Github !',
    'This website presents every projects I worked on, during my free time...',
    '<- Here, you can contact me.',
    'Or scroll down and follow me for the visit :)',
  ]
